...
public class CameraCrop : MonoBehaviour
{
	...
	public void UpdateCrop()
	{
		...
		{
			// Screen window is the target aspect ratio: use the whole area.
			_camera.rect = new Rect(0, 0, 1, 1);
		}
		else if (screenRatio > targetRatio)
		{
			// Screen window is wider than the target: pillarbox.
		...
		{
			// Screen window is narrower than the target: letterbox.
